# Run Python UnitTest in Incognito Mode with Selenium on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run your automation tests in incognito mode to simulate a clean, private browsing session. This sample shows how to configure incognito mode in Python UnitTest on the TestMu AI cloud.
...
You can specify the incognito option in the test file capabilities. The following is an example on how to set the incognito option using chromeOptions:
